...
namespace Tango
{
    ...
    public class VideoOverlayProvider
    {
        ...
        /// <param name="alignedIntrinsics">A TangoCameraIntrinsics filled with calibration intrinsics for the camera,
        /// this intrinsics is also aligned with device orientation.</param>
